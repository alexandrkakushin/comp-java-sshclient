...
public class MainClass {
    ...
    public static Logger getInstanceLogger() {
        if (logger == null) {
            logger = Logger.getLogger("ru.ak.sshclient");
        }
        return logger;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (System.getProperty("java.util.logging.config.class") == null
            ...
            try {                
                ...
                Handler handler = new FileHandler("%h/logs/sshclient/sshclient.log", 0, LOG_ROTATION_COUNT);
    ...
    private static boolean createLogDir() { 
        ...
        File logDir = new File(userHome + "/logs/sshclient");
        
        return logDir.mkdirs();
    }
    
    private static boolean existLogDir() {
        File logDir = new File(System.getProperty("user.home") + "/logs/sshclient/");
